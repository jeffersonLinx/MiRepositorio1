<nav class="navbar navbar-expand-lg navbar-dark bg-danger mb-2 shadow   rounded">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="logoPDF2.png" alt="" width="50" height="40" class="d-inline-block align-text-top">
    </a>
