...
<div class="container">
    <div class="row m-5 no-gutters shadow-lg">
        <div class="col-md-6 d-none d-md-block">
            <img src="logoautocar.png" class="img-fluid" style="min-height:100%;" />
        </div>
        <div class="col-md-6 bg-white p-5">
            ...
            <div>
                <form action="iniciar_sesion.php" method="post">
                    ...
                    <div class="pb-2">
                        <button type="submit" name="ingresar" class="btn btn-danger w-100 font-weight-bold mt-2">Ingresar</button>
                    </div>
                </form>
             </div>
        </div>
