...
// Establecer el nombre del cliente para la factura si está seleccionado
$_SESSION['nombreUsuarioFactura'] = ($clienteSeleccionado) ? $clienteSeleccionado->nombre : '';
    ...
    <div>
        ...
        <?php if($clienteSeleccionado){?>
            <div class="alert alert-primary mt-3" role="alert">
                ...
                <!-- Agregamos el nombre del cliente a la variable de sesión -->
                <?php $_SESSION['nombreClienteFactura'] = $clienteSeleccionado->nombre; ?>
